...
usage_metrics_router = routers.DefaultRouter()
usage_metrics_router.register(r"", FeatureUsageMetricsViewSet, basename="usage-metrics")
...
urlpatterns = [
    ...
    re_path(r"^usage-metrics/", include(usage_metrics_router.urls), name="usage-metrics"),
